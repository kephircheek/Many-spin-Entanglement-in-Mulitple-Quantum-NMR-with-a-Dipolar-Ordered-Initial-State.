...
In MQ NMR spectroscopy that parameter is the phase increment between the radio-frequency (rf) pulses, irradiating the system on the preparation and mixing periods of the MQ NMR experiment~\cite{Baum_1985}, \hl{in proportional to the evolution time}.
The phase increment leads to the separation of the signals,
...
It is also important for the investigation of the spreading-correlation~\cite{Baugh_2001,Baum_1986,S_nchez_2014,Munowitz_1987} and localization effects~\cite{Alvarez_2015,Wei_2018}.
...
and the temperatures $\alpha$ and $\beta$ \hl{are also single}.
